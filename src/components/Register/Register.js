...
class Register extends Component {
    ...
    onSubmitSignIn = () => {
        ...
        fetch("https://polite-eds-79454.herokuapp.com/register", {
            method: "post",
            ...
            .then(response => response.json()) // Server responses last user at register : res.json(database.users[database.users.length - 1])
            .then(user => {
                if (user.id) {
                    this.props.loadUser(user) // create/update user profile after registering
